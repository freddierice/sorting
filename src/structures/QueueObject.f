!
! Abstract Data Type Queue Implemented in Fortran(95)
! (c) 1995-2010,  Athanasios Migdalas
! version 0.6 @ 2003/07/15
!
...
MODULE QueueObject
  ...
  TYPE QueueT ! Queue able to hold Size-1 nodes, one less than expected.
     DATA_TYPE, ALLOCATABLE, DIMENSION(:) :: key ! OBS: To 0:Size-1
     INTEGER :: ErrorNr, Size
     LOGICAL :: Error
     INTEGER :: First, Last
  END TYPE QueueT
